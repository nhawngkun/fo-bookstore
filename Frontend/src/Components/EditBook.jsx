...
const EditBook = () => {
    ...
    const confirmEdit = async (e) => {
        ...
        const bookData = await axios.get(`${API_URL}/book/${data}`)
        if(bookData.data){
    ...
    const onSubmit = async (data) => {
        try {
            ...
            await axios.put(`${API_URL}/book/${book._id}`,data)
            ...
            <form className="max-w-sm mx-auto lg:mt-10" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-5">
                    ...
                    <textarea
                        ...
                        placeholder="Add full book content here for online reading"
                        {...register("content")}
                    ></textarea>
                </div>
                <button
